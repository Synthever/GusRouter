...
var KnownOAuthConfigs = map[string]OAuthClientConfig{
	"antigravity": {
		ClientID:     envOr("ANTIGRAVITY_OAUTH_CLIENT_ID", strings.Join([]string{"1071006060591-tmhssin2h21lcre235vtolojh4g403ep", "apps.googleusercontent.com"}, ".")),
		ClientSecret: envOr("ANTIGRAVITY_OAUTH_CLIENT_SECRET", strings.Join([]string{"GOCSPX", "K58FWR486LdLJ1mLB8sXC4z6qDAf"}, "-")),
	...
	"gemini-cli": {
		ClientID:     envOr("GEMINI_CLI_OAUTH_CLIENT_ID", strings.Join([]string{"681255809395-oo8ft2oprdrnp9e3aqf6av3hmdib135j", "apps.googleusercontent.com"}, ".")),
		ClientSecret: envOr("GEMINI_CLI_OAUTH_CLIENT_SECRET", strings.Join([]string{"GOCSPX", "4uHgMPm-1o7Sk-geV6Cu5clXFsxl"}, "-")),
		TokenURL:     "https://oauth2.googleapis.com/token",
	},
	"kimi-coding": {
