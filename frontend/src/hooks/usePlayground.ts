    ...
    const createSession = useCallback(
        (targetModel?: string) => {
            ...
            if (typeof document !== "undefined") {
                document.title = "Playground · GusRouter";
            }
            ...
            if (typeof document !== "undefined") {
                document.title =
                    target.title && target.title !== "New Conversation"
                        ? `${target.title} · GusRouter`
                        : "Playground · GusRouter";
            }
    ...
    function requestMessages(
        ...
        const base =
            currentMessages.length > 0
                ...
                : [{ role: "user", content: "Hello GusRouter!" }];
                        ...
                        try {
                            ...
                            if (titleRes.ok) {
                                ...
                                if (rawTitle && rawTitle.length > 2 && rawTitle.length < 60) {
                                    ...
                                    if (typeof document !== "undefined") {
                                        document.title = `${rawTitle} · GusRouter`;
                                    }
                                }
                            }
                        } catch {
                            ...
                            if (typeof document !== "undefined") {
                                document.title = `${fallbackTitle} · GusRouter`;
                            }
                        }
                    };
                    void fetchTitle();
